...
namespace MakeMovies.Api.Meta.Tmdb.Three.Find.Item {
    public class WithExternal_GetResponse_movie_results : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new WithExternal_GetResponse_movie_results and sets the default values.
        /// </summary>
        ...
        public static WithExternal_GetResponse_movie_results CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithExternal_GetResponse_movie_results();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"genre_ids", n => { GenreIds = n.GetCollectionOfPrimitiveValues<int?>()?.ToList(); } },
