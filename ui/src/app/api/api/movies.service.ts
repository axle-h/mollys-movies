...
export class MoviesService {
  ...
  public getMovie(
    ...
    return this.httpClient.get<Movie>(
      `${this.configuration.basePath}/api/v1/movies/${encodeURIComponent(String(id))}`,
      {
  ...
  public searchMovies(
    ...
    if (downloaded !== undefined && downloaded !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>downloaded, 'Downloaded');
    }
    if (genre !== undefined && genre !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>genre, 'Genre');
    }
    if (yearFrom !== undefined && yearFrom !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>yearFrom, 'YearFrom');
    }
    if (yearTo !== undefined && yearTo !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>yearTo, 'YearTo');
    }
    if (ratingFrom !== undefined && ratingFrom !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>ratingFrom, 'RatingFrom');
    }
    if (ratingTo !== undefined && ratingTo !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>ratingTo, 'RatingTo');
    }
