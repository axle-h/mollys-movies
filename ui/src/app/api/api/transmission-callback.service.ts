...
export class TransmissionCallbackService {
  ...
  public completeCallback(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/api/v1/transmission-callback/${encodeURIComponent(
        String(externalId),
      )}`,
      null,
      {
  ...
  public getAllContexts(
    ...
    return this.httpClient.get<TransmissionContextPaginated>(
      `${this.configuration.basePath}/api/v1/transmission-callback`,
      {
  ...
  public getContextByExternalId(
    ...
    return this.httpClient.get<TransmissionContext>(
      `${this.configuration.basePath}/api/v1/transmission-callback/${encodeURIComponent(
        String(externalId),
      )}`,
      {
