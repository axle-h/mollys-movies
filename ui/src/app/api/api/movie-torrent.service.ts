...
export class MovieTorrentService {
  ...
  public downloadMovie(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/api/v1/movies/${encodeURIComponent(
        String(movieId),
      )}/torrents/${encodeURIComponent(String(torrentId))}/download`,
      null,
      {
  ...
  public getLiveTransmissionStatus(
    ...
    return this.httpClient.get<LiveTransmissionStatus>(
      `${this.configuration.basePath}/api/v1/movies/${encodeURIComponent(
        String(movieId),
      )}/torrents/${encodeURIComponent(String(torrentId))}/live-status`,
      {
        responseType: <any>responseType,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
